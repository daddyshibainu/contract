...
interface IUniswapV2Router02 is IUniswapV2Router01 {
    ...
    contract DaddyShibaInu is Context , IERC20, Ownable {
    ...
    string private _name = "Daddy Shiba Inu";
    string private _symbol = "DaddyShibaInu";
    ...
    address public burnWallet = 0x0000000000000000000000000000000000000000; //3% for burn every transaction
